...
namespace WpfApp1 {
    ...
    public partial class projectdbDataSet : global::System.Data.DataSet {
        ...
        public partial class LoginsDataTable : global::System.Data.TypedTableBase<LoginsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LoginsRow AddLoginsRow(int Id, string ФИО, string Логин, string Пароль, decimal код_сотрудника) {
        ...
        public partial class LoginsRow : global::System.Data.DataRow {
            ...
            public decimal код_сотрудника {
                get {
                    return ((decimal)(this[this.tableLogins.код_сотрудникаColumn]));
                }
                set {
                    this[this.tableLogins.код_сотрудникаColumn] = value;
                }
            }
        }
...
namespace WpfApp1.projectdbDataSetTableAdapters {
    ...
    public partial class LoginsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Logins] WHERE (([Id] = @Original_Id) AND ([ФИО] = @Original_ФИ" +
                "О) AND ([Логин] = @Original_Логин) AND ([Пароль] = @Original_Пароль) AND ([код_с" +
                "отрудника] = @Original_код_сотрудника))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Logins] ([Id], [ФИО], [Логин], [Пароль], [код_сотрудника]) VAL" +
                "UES (@Id, @ФИО, @Логин, @Пароль, @код_сотрудника);\r\nSELECT Id, ФИО, Логин, Парол" +
                "ь, код_сотрудника FROM Logins WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Logins] SET [Id] = @Id, [ФИО] = @ФИО, [Логин] = @Логин, [Пароль] = @Пароль, [код_сотрудника] = @код_сотрудника WHERE (([Id] = @Original_Id) AND ([ФИО] = @Original_ФИО) AND ([Логин] = @Original_Логин) AND ([Пароль] = @Original_Пароль) AND ([код_сотрудника] = @Original_код_сотрудника));
SELECT Id, ФИО, Логин, Пароль, код_сотрудника FROM Logins WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ФИО, Логин, Пароль, код_сотрудника FROM dbo.Logins";
        ...
        public virtual int Delete(int Original_Id, string Original_ФИО, string Original_Логин, string Original_Пароль, decimal Original_код_сотрудника) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((decimal)(Original_код_сотрудника));
        ...
        public virtual int Insert(int Id, string ФИО, string Логин, string Пароль, decimal код_сотрудника) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((decimal)(код_сотрудника));
        ...
        public virtual int Update(int Id, string ФИО, string Логин, string Пароль, decimal код_сотрудника, int Original_Id, string Original_ФИО, string Original_Логин, string Original_Пароль, decimal Original_код_сотрудника) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(код_сотрудника));
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((decimal)(Original_код_сотрудника));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, string Логин, string Пароль, decimal код_сотрудника, int Original_Id, string Original_ФИО, string Original_Логин, string Original_Пароль, decimal Original_код_сотрудника) {
            return this.Update(Original_Id, ФИО, Логин, Пароль, код_сотрудника, Original_Id, Original_ФИО, Original_Логин, Original_Пароль, Original_код_сотрудника);
        }
    }
